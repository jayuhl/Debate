...
public class Team {
    ...
    public Team(Debater d1, Debater d2, boolean affirmitive) {
        this.d1 = d1;
        this.d2 = d2;
        this.teamID = (this.getTeamId() != null ? this.getTeamId() : this.d1.getSchool_ID() + 1);
   ...
   public void setIsAffirmitive(boolean isAff, int round) {//Round is 1, 2, 3, or 4, not zero
